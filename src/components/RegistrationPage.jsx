...
function CompleteStep({ config, registration, paymentResult }) {
  ...
  return <div className="registration-complete">
    ...
    <div className="registration-complete-actions">{paymentResult?.receiptUrl && <a className="button button-gold" href={paymentResult.receiptUrl} target="_blank" rel="noreferrer"><ReceiptText size={17} /> View Square receipt</a>}<a className="button button-green" href="/">Return to EL Hedaya</a></div>
